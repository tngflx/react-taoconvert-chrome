  ...
  port.onMessage.addListener(request => {
    if (request.msg_action === 'nswex_fill_form') {
      ...
      chrome.runtime.sendMessage({
        msg_action: 'nswex:update_hoverarrow',
        isEveryInputFilledFlag,
        isEveryInputSameFlag,
      });
      ...
      if (!isEveryInputFilledFlag) {
        ...
        input_elements_toinsert_template.forEach(
          ({ index, value }) => (all_input_els_per_row[index].value = String(value)),
        );
